...
<section id="services" class="services py-5">
	<div class="container">
		...
		<div class="row service_grids">
			...
			<div id="b32" class="col-lg-4 col-md-6 text-center">
				<div class="serv_grid1 slide-in">
			...
			<div id="c32" class="col-lg-4 col-md-6 text-center">
				<div class="serv_grid1 slide-inright">
					<i class="fas mb-4 fa-cloud"></i>
...
<section class="project py-5 text-center layer">
	<div class="container">
		...
		<a href="contact.php" class="text-uppercase"><i class="fas fa-envelope-open"></i> contact us </a>
	</div>
</section>
<!-- //project -->
